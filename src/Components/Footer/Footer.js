            ...
            >
                <div className="flex flex-col items-center text-center">
                    ...
                    <div className="flex space-x-4">
                        ...
                        <a href="https://github.com/ashwinn-si" target="_blank" className="text-accent hover:text-highlight transition-colors duration-200">
                            <Github size={22} />
                        </a>
                        <a href="https://www.linkedin.com/in/ashwinsi/" target="_blank" className="text-accent hover:text-highlight transition-colors duration-200">
                            <Linkedin size={22} />
                        </a>
                    </div>
                </div>
