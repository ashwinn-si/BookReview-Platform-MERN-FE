...
export default function BookCard({ Book }) {
    ...
    return (
        <motion.div className="max-w-sm w-full rounded-lg overflow-hidden shadow-lg bg-white border border-gray-200 hover:shadow-xl transition-shadow duration-300 m-2 relative flex flex-col  sm:h-56 md:h-64"
