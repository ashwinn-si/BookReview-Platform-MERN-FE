    ...
    return (
        <section className="py-12 bg-gray-50" id="testimonials">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                transition={{duration: 1, type:"easeInOut"}} viewport={{ once: true, amount: 0.05 }}
                >
                    <h2 className="text-2xl lg:text-3xl  font-bold text-gray-800 mb-2 font-header">What Our Users Say</h2>
                    ...
                    <div className="flex animate-slide space-x-6">
                        {[...testimonialData, ...testimonialData].map((testimonial, index) => (
                            <motion.div
                                ...
                                initial={{y: 100}}
                                whileInView={{y: 0}}
                                transition={{duration: 1.5, type:"easeInOut"}} viewport={{ once: true, amount: 0.05 }}
                            >
